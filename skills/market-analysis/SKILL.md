...
description: Run technical/market analysis on a stock using price data and indicators. Requires the ta MCP server.
---
...
Dispatch a **general-purpose** sub-agent with the `ta:market-analyst` agent prompt. The sub-agent should:
